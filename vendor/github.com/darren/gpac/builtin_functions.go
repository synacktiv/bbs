...
// https://hg.mozilla.org/mozilla-central/file/tip/netwerk/base/ProxyAutoConfig.cpp
//
// For licence please refer to https://www.mozilla.org/en-US/foundation/licensing/
